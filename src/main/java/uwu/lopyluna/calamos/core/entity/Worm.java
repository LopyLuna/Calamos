package uwu.lopyluna.calamos.core.entity;
...
import uwu.lopyluna.calamos.core.entity.entity_definitions.Boss;
...
public class Worm extends BossBarMonster implements Boss {
    ...
    protected void defineSynchedData(SynchedEntityData.Builder builder) {
        ...
        builder.define(MAX_SEGMENT_COUNT, 5);
        builder.define(SEGMENT_COUNT, 0);
    }
