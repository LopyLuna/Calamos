package uwu.lopyluna.calamos.elements.items;
...
public class ParticleSpewingItem extends Item {
    
    private final ParticleOptions mainParticle;
    private final ParticleOptions bonusParticle;
    public ParticleSpewingItem(Properties pProperties, ParticleOptions mainParticle, ParticleOptions bonusParticle) {
        super(pProperties);
