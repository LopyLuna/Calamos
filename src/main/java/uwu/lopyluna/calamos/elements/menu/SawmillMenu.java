...
public class SawmillMenu extends AbstractContainerMenu {
    ...
    private List<RecipeHolder<SawmillRecipe>> recipes;
    ...
    public SawmillMenu(int pContainerId, Inventory pPlayerInventory, FriendlyByteBuf friendlyByteBuf) {
        this(pContainerId, pPlayerInventory, ContainerLevelAccess.NULL);
    }

    public SawmillMenu(int pContainerId, Inventory playerInventory, final ContainerLevelAccess access) {
    ...
    private void setupRecipeList(Container p_40304_, ItemStack p_40305_) {
        ...
        if (!p_40305_.isEmpty()) {
            this.recipes = this.level.getRecipeManager().getRecipesFor(ModRecipes.SAW_MILLING.get(), createRecipeInput(p_40304_), this.level);
        }
    }
    ...
    public ItemStack quickMoveStack(Player player, int index) {
        ...
        if (slot != null && slot.hasItem()) {
            ...
            } else if (this.level.getRecipeManager().getRecipeFor(ModRecipes.SAW_MILLING.get(), new SingleRecipeInput(itemstack1), this.level).isPresent()) {
