...
public class CuttingProvider {
    ...
    private static void recipesMetalGrinding(RecipeOutput consumer) {
        ...
        addMetalGrinding(consumer, ModItems.URANIUM_INGOT, 1, ModTags.forgeItemTag("ingots/uranium"), ModItems.URANIUM_INGOT, RecipeCategory.MISC).save(consumer, metalGrindingLocation("tag_conversion/ingot", "uranium", "calamos"));
        addMetalGrinding(consumer, ModItems.VOLCANITE_INGOT, 1, ModTags.forgeItemTag("ingots/volcanite"), ModItems.VOLCANITE_INGOT, RecipeCategory.MISC).save(consumer, metalGrindingLocation("tag_conversion/ingot", "volcanite", "calamos"));
        addMetalGrinding(consumer, ModItems.ULTIMITA_INGOT, 1, ModTags.forgeItemTag("ingots/ultimita"), ModItems.ULTIMITA_INGOT, RecipeCategory.MISC).save(consumer, metalGrindingLocation("tag_conversion/ingot", "ultimita", "calamos"));
        addMetalGrinding(consumer, ModItems.TERRAULITE_INGOT, 1, ModTags.forgeItemTag("ingots/terraulite"), ModItems.TERRAULITE_INGOT, RecipeCategory.MISC).save(consumer, metalGrindingLocation("tag_conversion/ingot", "terraulite", "calamos"));
        addMetalGrinding(consumer, ModItems.STARINIUM_INGOT, 1, ModTags.forgeItemTag("ingots/starinium"), ModItems.STARINIUM_INGOT, RecipeCategory.MISC).save(consumer, metalGrindingLocation("tag_conversion/ingot", "starinium", "calamos"));
        addMetalGrinding(consumer, ModItems.PLATINUM_INGOT, 1, ModTags.forgeItemTag("ingots/platinum"), ModItems.PLATINUM_INGOT, RecipeCategory.MISC).save(consumer, metalGrindingLocation("tag_conversion/ingot", "platinum", "calamos"));
        addMetalGrinding(consumer, ModItems.OBSTEEL_INGOT, 1, ModTags.forgeItemTag("ingots/obsteel"), ModItems.OBSTEEL_INGOT, RecipeCategory.MISC).save(consumer, metalGrindingLocation("tag_conversion/ingot", "obsteel", "calamos"));
        addMetalGrinding(consumer, ModItems.MAGNETITE_INGOT, 1, ModTags.forgeItemTag("ingots/magnetite"), ModItems.MAGNETITE_INGOT, RecipeCategory.MISC).save(consumer, metalGrindingLocation("tag_conversion/ingot", "magnetite", "calamos"));
        addMetalGrinding(consumer, ModItems.LEAD_INGOT, 1, ModTags.forgeItemTag("ingots/lead"), ModItems.LEAD_INGOT, RecipeCategory.MISC).save(consumer, metalGrindingLocation("tag_conversion/ingot", "lead", "calamos"));
        addMetalGrinding(consumer, ModItems.METEORITE_INGOT, 1, ModTags.forgeItemTag("ingots/meteorite"), ModItems.METEORITE_INGOT, RecipeCategory.MISC).save(consumer, metalGrindingLocation("tag_conversion/ingot", "meteorite", "calamos"));
        addMetalGrinding(consumer, ModItems.BLOODBORE_INGOT, 1, ModTags.forgeItemTag("ingots/bloodbore"), ModItems.BLOODBORE_INGOT, RecipeCategory.MISC).save(consumer, metalGrindingLocation("tag_conversion/ingot", "bloodbore", "calamos"));
        addMetalGrinding(consumer, ModItems.CALAMATIUM_INGOT, 1, ModTags.forgeItemTag("ingots/calamatium"), ModItems.CALAMATIUM_INGOT, RecipeCategory.MISC).save(consumer, metalGrindingLocation("tag_conversion/ingot", "calamatium", "calamos"));
        addMetalGrinding(consumer, ModItems.ECTOLIGHT_INGOT, 1, ModTags.forgeItemTag("ingots/ectolight"), ModItems.ECTOLIGHT_INGOT, RecipeCategory.MISC).save(consumer, metalGrindingLocation("tag_conversion/ingot", "ectolight", "calamos"));
        addMetalGrinding(consumer, ModItems.ELEGANT_BLOOM, 1, ModTags.forgeItemTag("ingots/elegant"), ModItems.ELEGANT_BLOOM, RecipeCategory.MISC).save(consumer, metalGrindingLocation("tag_conversion/ingot", "elegant", "calamos"));
        addMetalGrinding(consumer, ModItems.STELLAR_INGOT, 1, ModTags.forgeItemTag("ingots/stellar"), ModItems.STELLAR_INGOT, RecipeCategory.MISC).save(consumer, metalGrindingLocation("tag_conversion/ingot", "stellar", "calamos"));
        addMetalGrinding(consumer, ModItems.PALLADIUM_INGOT, 1, ModTags.forgeItemTag("ingots/palladium"), ModItems.PALLADIUM_INGOT, RecipeCategory.MISC).save(consumer, metalGrindingLocation("tag_conversion/ingot", "palladium", "calamos"));

        addMetalGrinding(consumer, ModBlocks.URANIUM_BLOCK, 1, ModTags.forgeItemTag("storage_blocks/uranium"), ModBlocks.URANIUM_BLOCK, RecipeCategory.BUILDING_BLOCKS).save(consumer, metalGrindingLocation("tag_conversion/block", "uranium", "calamos"));
        addMetalGrinding(consumer, ModBlocks.PALLADIUM_BLOCK, 1, ModTags.forgeItemTag("storage_blocks/palladium"), ModBlocks.PALLADIUM_BLOCK, RecipeCategory.BUILDING_BLOCKS).save(consumer, metalGrindingLocation("tag_conversion/block", "palladium", "calamos"));
    }
