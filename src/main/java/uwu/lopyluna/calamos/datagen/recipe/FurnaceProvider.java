...
public class FurnaceProvider {
    ...
    private static void blasting(RecipeOutput consumer) {
        ...
        smeltAndBlast(RecipeCategory.MISC, ModItems.URANIUM_INGOT.get(), ModItems.RAW_URANIUM.get(), 0.7f, secondsToTicks(10), consumer);
        smeltAndBlast(RecipeCategory.MISC, ModItems.PALLADIUM_INGOT.get(), ModItems.RAW_PALLADIUM.get(), 0.7f, secondsToTicks(10), consumer);
        ...
        smeltAndBlast(RecipeCategory.MISC, ModItems.JADE.get(), ModBlocks.JADE_ORE.asItem(), 1.0f, secondsToTicks(10), consumer);
